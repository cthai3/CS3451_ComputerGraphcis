...
def green_mountain():
    ...
    grid = 5
    for x in range(-100, 100, grid):
        for y in range(100, -100, -grid):
            beginShape()
            texture(mountainTexture)
            vertex(x, y - grid, 0, (100 - abs(x)) / 200.0,     (100 + y - grid) / 200.0)    
            vertex(x + grid, y - grid, 0, (100 - abs(x + grid)) / 200.0, (100 + y - grid) / 200.0)   
            vertex(x + grid, y, 0, (100 - abs(x + grid)) / 200.0, (100 + y) / 200.0)   
            vertex(x, y, 0, (100 - abs(x)) / 200.0, (100 + y) / 200.0)     
            endShape()
    popMatrix()
